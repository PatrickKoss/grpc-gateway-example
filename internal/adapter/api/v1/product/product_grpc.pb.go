...
func (c *productServiceClient) CreateProduct(ctx context.Context, in *CreateProductBody, opts ...grpc.CallOption) (*proto.Message, error) {
...
func (c *productServiceClient) GetProducts(ctx context.Context, in *ProductParams, opts ...grpc.CallOption) (*ListProductsResponse, error) {
...
func (c *productServiceClient) GetProduct(ctx context.Context, in *ProductId, opts ...grpc.CallOption) (*GetProductResponse, error) {
...
func (c *productServiceClient) DeleteProduct(ctx context.Context, in *ProductId, opts ...grpc.CallOption) (*proto.Message, error) {
	out := new(proto.Message)
...
func (UnimplementedProductServiceServer) CreateProduct(context.Context, *CreateProductBody) (*proto.Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateProduct not implemented")
}
func (UnimplementedProductServiceServer) GetProducts(context.Context, *ProductParams) (*ListProductsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProducts not implemented")
}
func (UnimplementedProductServiceServer) GetProduct(context.Context, *ProductId) (*GetProductResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProduct not implemented")
}
func (UnimplementedProductServiceServer) DeleteProduct(context.Context, *ProductId) (*proto.Message, error) {
...
func _ProductService_CreateProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).CreateProduct(ctx, req.(*CreateProductBody))
	}
